            ...
            <div>
                {
                    formState.map((_, index) => (
                        formState[index].isGuardian && (formState[index].id === "" || formState[index].id === undefined) ? <></> :
                            <div key={index} className='flex w-full justify-between items-center space-x-1 h-fit'>
