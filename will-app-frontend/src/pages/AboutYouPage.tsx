...
const AboutYouPage = () => {
    ...
    return (
        <div className='flex flex-col items-start h-full'>
            <div className='w-full bg-white max-w-fit shadow-md border-l-[20px] p-4 
            border-[#358477] shadow-gray-400 justify-center flex flex-col'>
                ...
                space-y-2 text-wrap'>
                    <Item label={"Full Name"} text={(personalDetails.title === undefined ? "" : personalDetails.title) + ". " + (personalDetails.firstName ?? "") + " " + (personalDetails.lastName === undefined ? "" : personalDetails.lastName)} />
