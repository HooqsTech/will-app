...
export const generatePDF = async (req: Request, res: Response) => {
    try {
        ...
        const content : any []= [
            ...
            {
            text: `I, ${honorific} ${personalDetails?.fullName}, S/o Mr. ${personalDetails?.fatherName}, born on ${new Date(dob).toLocaleDateString("en-IN", {
              month: "long",
              day: "numeric",
              year: "numeric",
